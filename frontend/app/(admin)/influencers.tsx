      ...
      <ScrollView style={styles.content}>
        {loading ? (
          ...
          <View style={styles.emptyState}>
            <MaterialIcons name="star" size={64} color="#9CA3AF" />
          ...
          influencers.map((influencer: any) => (
            <View key={influencer._id} style={styles.influencerCard}>
              ...
              <Text style={styles.influencerType}>Type: {influencer.type}</Text>
              <TouchableOpacity
                style={styles.viewButton}
                onPress={() => router.push({ pathname: '/admin/influencer-detail', params: { influencer_id: influencer._id } })}
              >
